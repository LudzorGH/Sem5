...
public class Sale 
{
	 ...
	 * @param item
	 * @return a string of the item added to the sale
	 */
	...
	/**
	 * method returns how many of an item that has been added
	 * @return amount as an int
	 */
	public int getAmountOfItem(Item item)
	{
		int itemsIndexInList = isItemAlreadyInList(item);
		if(itemsIndexInList != -1)
		{
			return addedItems.get(itemsIndexInList).getAmount();
		}
		else
		{
			return 0;
